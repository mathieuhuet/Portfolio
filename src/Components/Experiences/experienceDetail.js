export const experienceDetail = {
  ...
  codeworksFR: <div className="ExperienceDetail">
  ...
  codeworksEN: <div className="ExperienceDetail">
  ...
  mi8FR: <div className="ExperienceDetail">
...
d'afficheurs dynamiques.</div>
  ...
  mi8EN: <div className="ExperienceDetail">
  ...
  uqamFR: <div className="ExperienceDetail">
